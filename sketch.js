...
function preload(){
  ...
  trex_collided = loadAnimation("trex_collided_cor.png");
  
  groundImage = loadImage("ground_cor.png");
  
  cloudImage = loadImage("cloud_cor.png");
  ...
  gameOverImg = loadImage("gameOver_cor.png");
  restartImg = loadImage("restart_cor.png");
}
